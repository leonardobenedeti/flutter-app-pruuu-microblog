...
mixin _$PruuuItViewModel on _PruuuItViewModel, Store {
  final _$pruuuItStateAtom = Atom(name: '_PruuuItViewModel.pruuuItState');
  ...
  final _$pruuublishAsyncAction = AsyncAction('_PruuuItViewModel.pruuublish');
  ...
  final _$removePruuuAsyncAction = AsyncAction('_PruuuItViewModel.removePruuu');
